...
function Services() {
  return (
    ...
    <h2 className="services-heading">Corporate Transition Made Simple</h2>
    ...
    <div className="services-card">
        <div className="services-icon ic1">1</div>
        <h2 className="services-title">Career Consultation</h2>
